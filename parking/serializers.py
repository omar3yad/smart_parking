...
class ReservationSerializer(serializers.ModelSerializer):
    ...
    floor = serializers.CharField(source='slot.floor', read_only=True)
    is_active = serializers.BooleanField(source='slot.status', read_only=True)

    class Meta:
        model = Reservation
        fields = ['id', 'slot', 'slot_number', 'license_plate', 'start_time', 'end_time', 'reservation_code', 'floor', 'is_active', 'created_at']
        read_only_fields = ['reservation_code', 'created_at','is_active']
